package dongwoongkim.springbootboard.config.swagger;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.OAS_30)
                .apiInfo(apiInfo()) // 2
                .select() // 3
                .apis(RequestHandlerSelectors.basePackage("dongwoongkim.springbootboard.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .licenseUrl("https://github.com/Dongwoongkim/finalBoard")
                .version("1.0")
                .build();
    }
